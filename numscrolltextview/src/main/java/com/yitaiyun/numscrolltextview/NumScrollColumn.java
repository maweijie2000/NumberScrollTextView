 ...
 *
 */
class NumScrollColumn {
    private final NumScrollCharacterList[] characterLists;
    private final NumScrollDrawMetrics metrics;

    private char currentChar = NumScrollUtils.EMPTY_CHAR;
    private char targetChar = NumScrollUtils.EMPTY_CHAR;
    ...
    NumScrollColumn(NumScrollCharacterList[] characterLists, NumScrollDrawMetrics metrics) {
    ...
    private void setCharacterIndices() {
        ...
        for (int i = 0; i < characterLists.length; i++) {
            final NumScrollCharacterList.CharacterIndices indices =
