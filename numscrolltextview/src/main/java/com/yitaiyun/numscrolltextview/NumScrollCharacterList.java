...
class NumScrollCharacterList {
    ...
    NumScrollCharacterList(String characterList) {
        if (characterList.contains(Character.toString(NumScrollUtils.EMPTY_CHAR))) {
        ...
        this.characterList[0] = NumScrollUtils.EMPTY_CHAR;
        for (int i = 0; i < length; i++) {
    ...
    CharacterIndices getCharacterIndices(char start, char end) {
        ...
        if (start != NumScrollUtils.EMPTY_CHAR && end != NumScrollUtils.EMPTY_CHAR &&
                endIndex < startIndex) {
    ...
    private int getIndexOfChar(char c) {
        if (c == NumScrollUtils.EMPTY_CHAR) {
            return 0;
